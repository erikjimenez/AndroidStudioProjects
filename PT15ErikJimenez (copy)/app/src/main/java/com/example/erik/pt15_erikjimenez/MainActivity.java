...
,BlankFragment4.OnFragmentInteractionListener{
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            test=true;
            nom=new BlankFragment();
        } else if (id == R.id.nav_gallery) {
            test=true;
            nom=new BlankFragment2();
        } else if (id == R.id.nav_slideshow) {
            test=true;
            nom=new BlankFragment3();
        } else if (id == R.id.nav_manage) {
            test=true;
            nom=new BlankFragment4();
        ...
        if (test) {
            getSupportFragmentManager().beginTransaction().replace(R.id.camera, nom).commit();
        }DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
        drawer.closeDrawer(GravityCompat.START);
        return true;
    }
